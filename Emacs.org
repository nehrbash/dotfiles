...
(add-hook 'org-mode-hook   (lambda ()
                             (set-face-attribute 'org-table nil :inherit 'fixed-pitch) ;; sometimes needs to fix this depending on theme
                             (set-face-attribute 'org-block nil :inherit 'fixed-pitch) ;; sometimes needs to fix this depending on theme
