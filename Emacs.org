...
- [[#general-settings][General Settings]]
  ...
  - [[#tramp][TRAMP]]
  - [[#load-all-environment-variable][Load All Environment Variable]]
...
** Load All Environment Variable
   ...
   too lazy to figure out what env variable I am missing so I am just loading them all.
   - Was using  exec-path-from-shell
...
(use-package corfu-candidate-overlay
  :vc (corfu-candidate-overlay :url "https://code.bsdgeek.org/adam/corfu-candidate-overlay"
                               :branch "master")
...
*** HOLD tempel - Snippets

   not quite there yet 
   
#+begin_src emacs 
(use-package tempel
  :custom (tempel-trigger-prefix "<")   ;; Require trigger prefix before template name when completing.
...
#+begin_src emacs
(use-package eaf
  :vc (eaf :url "https://github.com/emacs-eaf/emacs-application-framework.git")
  :custom
...
(use-package holo-layer
  :vc (holo-layer :url "https://github.com/manateelazycat/holo-layer/tree/master"))
#+end_src   
