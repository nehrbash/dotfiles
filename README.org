...
* Agent Shell
   ...
   [[https://github.com/xenodium/agent-shell][agent-shell]] is a native Emacs buffer to interact with LLM agents (Claude Code, Gemini CLI, etc.) via the Agent Client Protocol (ACP).
